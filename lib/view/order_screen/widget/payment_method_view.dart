            ...
            return  InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Image.network(data.logoImage!,height: 40,width: 40,),
                    SizedBox(width: 5,),
                    Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text("${data.methodName}",style: const TextStyle(fontSize: 15,fontWeight: FontWeight.w600,color: AppColors.textBlack),),
                            Obx((){
